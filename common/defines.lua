...
country = {
	...
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.7,
	...
	ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT = 1.0, -- Crimefight depends on both state admin eff. and admin spending, admin spending percent effect is set to (1-ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT)
	...
	NONCORE_TAX_PENALTY = -0.005, -- -5% for each non-core in state
	...
	MOVEMENT_RADICALISM_PASSED_REFORM_EFFECT  = -13,
	MOVEMENT_RADICALISM_NATIONALISM_FACTOR = 0.03,
	...
	UNCIV_TECH_SPREAD_MAX = 2.60,
	UNCIV_TECH_SPREAD_MIN = 1.35,
	...
	MAX_RESEARCH_POINTS = 1488228, -- max RP you can store for uncivs
},

economy = {
	MAX_DAILY_RESEARCH		    = 1488,
...
military = {
	...
	LEADER_AGE_DEATH_FACTOR = 14, -- higher value means leaders live longer
...
pops = {
	BASE_CLERGY_FOR_LITERACY = 0.01, 
	MAX_CLERGY_FOR_LITERACY = 0.09, 
	LITERACY_CHANGE_SPEED = 0.1,


	ASSIMILATION_SCALE = 0.4,
	CONVERSION_SCALE = 0.4,
	IMMIGRATION_SCALE = 0.004,

	PROMOTION_SCALE = 0.002,
	PROMOTION_ASSIMILATION_CHANCE = 1.0,
	LUXURY_THRESHOLD = 500,
	BASE_GOODS_DEMAND = 0.2,
	BASE_POPGROWTH = 0.0005,
	MIN_LIFE_RATING_FOR_GROWTH = 15,
	...
	CON_LITERACY = 0.01,
	CON_LUXURY_GOODS = 0.01,
	CON_POOR_CLERGY = -2.5,
	CON_MIDRICH_CLERGY = -1.25,
	CON_REFORM_IMPACT = -50,
	CON_COLONIAL_FACTOR = 0.01,
